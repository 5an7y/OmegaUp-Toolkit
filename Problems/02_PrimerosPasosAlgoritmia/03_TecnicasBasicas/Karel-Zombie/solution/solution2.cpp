...
int64_t calc_infectados(
    ...
    int64_t overlap_nw = max((int64_t)0, off_side_north - x),
            overlap_ne = max((int64_t)0, off_side_east - (N - y + 1) ),
            overlap_sw = max((int64_t)0, off_side_south - x),
            overlap_se = max((int64_t)0, off_side_east - y);
