...
- **Para el 40% de los puntos**: Puedes llamar a la función `Mejor` un máximo de $2^{N}$ veces.

- **Para el 100% de los puntos**: Puedes llamar a la función `Mejor` un máximo de $\lceil \frac{1}{3} \cdot 2^{N + 1} \rceil$.
